...
public:
  ...
  /// Returns 3d SuperPointGlue features in the global frame
  std::vector<Eigen::Vector3d> get_features_SuperPointGlue();
...
protected:
  ...
  /// Our SuperPoint and SuperGlue tracker
  std::shared_ptr<ov_core::TrackBase> trackSuperPointGlue;
  ...
  /// Our SLAM/ARUCO/SuperPointGlue feature updater
